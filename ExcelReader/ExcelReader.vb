...
Public Class ExcelReader
    ...
    Public Function GetSheetLists() As System.Data.DataTable
        Dim dt As New System.Data.DataTable("Sheets")
        Dim dc As New System.Data.DataColumn("Name", GetType(String))
        dt.Columns.Add(dc)

        ' Loop over all sheets.
        For i As Integer = 1 To _xlsWorkBook.Sheets.Count
            ' Get sheet.
            Dim sheet As Worksheet = _xlsWorkBook.Sheets(i)
    ...
    Public Function GetSheetCount() As Integer
        Return _xlsWorkBook.Sheets.Count
    End Function

    Public Function GetDataSet(Optional ByVal SetColumnNameWithColumnHeader As Boolean = False, Optional ByVal AutoChangeColumnDataType As Boolean = False) As System.Data.DataSet
        Return ToDataSet(_xlsWorkBook, SetColumnNameWithColumnHeader, AutoChangeColumnDataType)
    End Function

    Public Function GetDataTable(ByVal tbIndex As Integer, Optional ByVal SetColumnNameWithColumnHeader As Boolean = False, Optional ByVal AutoChangeColumnDataType As Boolean = False) As System.Data.DataTable
        Return ToDataSet(_xlsWorkBook, SetColumnNameWithColumnHeader, AutoChangeColumnDataType).Tables(tbIndex)
    End Function

    Private Function ChangeDataType(ByVal dtSource As System.Data.DataTable, ByVal colName As String, ByVal targetDataType As Type, ByRef dtOut As System.Data.DataTable) As Boolean
        dtOut = dtSource.Clone
        Try
            dtOut.Columns(colName).DataType = targetDataType
            For Each dr As System.Data.DataRow In dtSource.Rows
                dtOut.ImportRow(dr)
            Next
            Return True
    ...
    Private Function ToDataSet(ByVal xlsWorkBook As Workbook, Optional ByVal SetColumnNameWithColumnHeader As Boolean = False, Optional ByVal AutoChangeColumnDataType As Boolean = False) As System.Data.DataSet
        ...
        For i As Integer = 1 To xlsWorkBook.Sheets.Count
            ...
            ds.Tables.Add(ToDataTable(sheet, SetColumnNameWithColumnHeader, AutoChangeColumnDataType))
        Next

        Return ds
    End Function

    Private Function ToDataTable(ByVal xlsWorkSheet As Worksheet, Optional ByVal SetColumnNameWithColumnHeader As Boolean = False, Optional ByVal AutoChangeColumnDataType As Boolean = False) As System.Data.DataTable
        ' Get sheet.
        ...
        If array IsNot Nothing Then
            ...
            Dim HeaderFlag As Boolean = SetColumnNameWithColumnHeader
            ...
            If AutoChangeColumnDataType And IsAssignFirstDataRow Then
                ...
                For i As Integer = 0 To dt.Columns.Count - 1
                    ...
                    If Not t1.Equals(t2) Then
                        ...
                        ChangeDataType(dt, dcName, t2, dtClone)
                        dt = dtClone.Copy
                    End If
                Next
            End If
